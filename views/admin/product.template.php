...
<table>
  ...
  <tr>
    ...
    <td><?=$row->imageid?></td>
    <td><input type='checkbox' name='for-delete-product[]' value='<?=$row->productid?>'></td>
  </tr>
  <?php endforeach;?>
</table>
...
<td><button type='submit' name='product-update'>Update</button></td>
</tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td><button type='submit' name='product-insert'>Add</button></td>
  </tr>
</table>
</form>