...
<table>
  ...
  <tr>
    <td><?=$row->imageid?></td>
    <td><a href='<?=$row->src?>' target="_blank"><img src='<?=$row->src?>' alt='<?=$row->alt?>'></a></td>
    <td><?=$row->alt?></td>
    <td><input type='checkbox' name='for-delete-image[]' value='<?=$row->imageid?>'></td>
  </tr>
  <?php endforeach;?>
</table>
...
<td>
  <select id='update-images' name='imageid'>
    ...
    <?php foreach ($image as $row):?>
    <option value='<?=$row->imageid?>'><?=$row->imageid?></option>
    <?php endforeach;?>
  </select>
</td>
<td>
...
<td><button type='submit' name='image-update'>Update</button></td>
</tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td><input type='text' name='alt' required></td>
    <td><button type='submit' name='image-insert'>Add</button></td>
  </tr>
</table>
</form>
</div>