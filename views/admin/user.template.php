...
<table>
  ...
  <tr>
    ...
    <td><?=$row->email?></td>
    <td><?=$row->roleid?></td>
    <td><input type='checkbox' name='for-delete-user[]' value='<?=$row->userid?>'></td>
  </tr>
  <?php endforeach;?>
</table>
...
<td><button type='submit' name='user-update'>Update</button></td>
</tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td><button type='submit' name='user-insert'>Add</button></td>
  </tr>
</table>
</form>